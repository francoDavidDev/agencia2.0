...
const CustomerReviews = () => {
  return (
    ...
    <h3 className="font-palanquin text-center text-primary text-3xl md:text-4xl font-bold">
  ¿Quiénes son
  <span className="text-sky-blue"> Integrantes </span>
  de
  <span className="text-sky-blue"> Visibilidad Web</span> ?
</h3>
<p className="m-auto mt-4 max-w-lg text-center text-white text-base md:text-lg">
