...
import { FAQ_COMUNITY_MANAGER } from "../constants/faq/comunityManager";
//import components


const FaqComunityManager = () => {
  // desctructure faq data
  const { icon, title, accordions } = FAQ_COMUNITY_MANAGER;
...
export default FaqComunityManager;
